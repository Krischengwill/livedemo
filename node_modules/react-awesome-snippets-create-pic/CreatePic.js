 ...
 *
 */
var CreatePic = (_temp2 = _class = function (_Component) {
    ...
    function CreatePic() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CreatePic.__proto__ || Object.getPrototypeOf(CreatePic)).call.apply(_ref, [this].concat(args))), _this), _this.state = { img: null, loading: true, error: null }, _this.create = function () {
    ...
    _createClass(CreatePic, [{
        ...
        value: function componentDidMount() {
            ...
            this.create().then(function () {
                var img = _this2.canvas.toDataURL('image/jpeg', 0.7);
                _this2.setState({
                    img: img
                }, function () {
                    _this2.props.onload && _this2.props.onload(img);
                });
        ...
        value: function render() {
            ...
            if (img) {
                return React.createElement('img', { src: img, alt: 'create pic output', className: 'create-pic-output' });
            }
